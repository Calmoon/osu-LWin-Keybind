...
If you ever star using a new keyboard and this stops working, delete the keyboardHWID.ini file that is generated on the first run and run the script again.
